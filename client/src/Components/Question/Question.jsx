...
const Question = ({ unlocked, userId, questionData, initResetQ, fromAnswers }) => {
    ...
    return (
        <div className='question-wrapper'>
            ...
            <div className='q-content flex-col-top-l'>
                <Link id={inputs.questionId + '-title-Link'} to={'/answers?questionId=' + inputs.questionId} >
                    {!edit && <div className='q-title-Link'>{inputs.title}</div>}
                </Link>
                <input
                    type='text'
